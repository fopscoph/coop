                ...
                <div className="flex flex-wrap items-start pt-15 pb-10 justify-between">
                    ...
                    <div className="xl:w-7/12 flex flex-col xl:flex-row">
                        <div className="w-full xl:w-2/6">
                            ...
                            <ul>
                                <li className="text-xs font-light mb-2">About Us</li>
                                <li className="text-xs font-light mb-2">Partners</li>
                                <li className="text-xs font-light">Contact Us</li>
                            </ul>
                        </div>
                        <div className="w-full xl:w-2/6">
                        ...
                        <div className="w-full xl:w-2/6">
                            <h4 className="text-sm font-semibold mb-5">Subscribe To Our Newsletter</h4>
                        </div>
                    </div>
                </div>
            </div>
