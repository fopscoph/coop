    ...
    return (
        <section className="mx-auto xl:w-4/5 px-5 py-20">
            <div className="w-full xl:w-5/6 mx-auto mb-16 text-center">
                ...
                <h3 className="text-4xl mb-5 font-semibold cloud-burst">The Value of Being a FOPSCo Member</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="px-5 py-20 shadow-[0_9px_10px_1px_rgba(0,0,0,0.14)] rounded-2xl">
